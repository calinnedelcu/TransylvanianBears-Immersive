...
DESKTOP_SPECS = (
    CameraSpec(
        ...
        tier="desktop",
        positions=((16.0, 20.0, 52.0), (11.5, 14.5, 36.0), (7.0, 10.0, 26.0), (3.2, 6.6, 20.4), (0, 5.3, 16.5)),
        targets=((0.0, 4.2, 1.4), (-0.2, 4.4, 5.0), (-0.4, 4.6, 8.2), (-0.3, 5.0, 11.6), (0, 4.7, 14.2)),
        fov_start=36,
        fov_end=43,
        fov_breath=-0.8,
        roll_peak=-0.38,
...
def compact_spec(spec):
    if spec.chapter == "Threshold":
        ...
        return CameraSpec(
            ...
            tier="mobile",
            positions=((4.0, 16.5, 42.0), (2.6, 12.0, 30.0), (1.6, 8.8, 23.0), (1.1, 6.6, 19.6), (0, 5.65, 16.5)),
            targets=((0.2, 4.0, 1.6), (0.1, 4.2, 6.0), (0.0, 4.8, 10.4), (0, 5.2, 13.6), (0, 4.85, 14.2)),
            fov_start=58,
            fov_end=62,
            fov_breath=-0.66,
            roll_peak=-0.245,
