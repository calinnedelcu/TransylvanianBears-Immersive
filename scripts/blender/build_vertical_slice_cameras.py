...
DESKTOP_SPECS = (
    CameraSpec(
        ...
        tier="desktop",
        positions=((14.0, 32.0, 78.0), (11.0, 20.0, 48.0), (7.2, 11.5, 29.0), (3.2, 6.6, 20.4), (0, 5.3, 16.5)),
        targets=((0.0, 4.4, 1.2), (-0.2, 4.4, 5.0), (-0.4, 4.6, 8.2), (-0.3, 5.0, 11.6), (0, 4.7, 14.2)),
        fov_start=32,
        fov_end=43,
        fov_breath=-0.8,
        roll_peak=-0.38,
    ...
    CameraSpec(
        ...
        tier="desktop",
        positions=((0, 5.3, 16.5), (1.35, 3.55, 10.2), (-1.65, 2.75, 2.4), (2.45, 3.0, -7.2), (1.7, 5.1, -18)),
        targets=((0, 4.7, 14.2), (-0.2, 2.2, 4.8), (0.45, 1.95, -5.4), (-0.55, 2.25, -14.8), (-0.4, 4.6, -24)),
        fov_start=43,
        fov_end=49,
        fov_breath=0.8,
        roll_peak=0.62,
...
def compact_spec(spec):
    if spec.chapter == "Threshold":
        # Establishing aerial first: the citadel has to sit in country, not fill the frame.
        return CameraSpec(
            chapter=spec.chapter,
            chapter_dir=spec.chapter_dir,
            asset_id=spec.asset_id.replace("desktop", "mobile"),
            tier="mobile",
            positions=((2.2, 30.0, 68.0), (1.8, 18.0, 40.0), (1.4, 10.4, 26.0), (1.1, 6.6, 19.6), (0, 5.65, 16.5)),
            targets=((0.2, 2.4, 2.0), (0.1, 3.6, 6.0), (0.0, 4.8, 10.4), (0, 5.2, 13.6), (0, 4.85, 14.2)),
            fov_start=64,
            fov_end=62,
            fov_breath=-0.66,
            roll_peak=-0.245,
