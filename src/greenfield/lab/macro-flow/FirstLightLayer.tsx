...
export function FirstLightLayer({ progressRef, reducedMotion }: FirstLightLayerProps) {
  ...
  useLayoutEffect(() => {
    ...
    markInstanceMatrixDirty(bannerRodRef.current);
  }, [instanceTransform]);
  ...
  }, [bannerMaterials, detailGeometries, detailMaterials]);
